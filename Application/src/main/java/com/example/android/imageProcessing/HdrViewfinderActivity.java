...
public class HdrViewfinderActivity extends AppCompatActivity implements
    ...
    private TextView mManualExposureText, mAutoExposureText;
    ...
    ArrayList<CaptureRequest> mRequests = new ArrayList<CaptureRequest>(2);
    ...
    private Object mManualExposureTag = new Object();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mManualExposureText = (TextView) findViewById(R.id.even_exposure);
    ...
    private GestureDetector.OnGestureListener mViewListener
        ...
        public boolean onScroll(MotionEvent e1, MotionEvent e2, float distanceX, float distanceY) {
            ...
            if (xPosNorm > 0.5) {
                mExposure *= scaleFactor;
            } else {
                mThreshold *= scaleFactor/10;
            }
    ...
    private void switchRenderMode(int direction) {
        if (mCameraOps != null) {
            mRenderMode = (mRenderMode + direction) % 7;
    ...
    private void setupProcessor() {
        ...
        mProcessingSurface = mProcessor.getInputHdrSurface();
    ...
    public void setHdrBurst() {
        ...
        mBuilder.set(CaptureRequest.SENSOR_SENSITIVITY, 1600);
        mBuilder.set(CaptureRequest.SENSOR_FRAME_DURATION, ONE_SECOND / 30);

        mBuilder.set(CaptureRequest.SENSOR_EXPOSURE_TIME, mExposure);
        mBuilder.setTag(mManualExposureTag);
        mRequests.set(0, mBuilder.build());

//        mBuilder.set(CaptureRequest.SENSOR_EXPOSURE_TIME, mExposure);
//        mBuilder.setTag(mManualExposureTag);
//        mRequests.set(1, mBuilder.build());

//        mCameraOps.setRepeatingBurst(mRequests, mCaptureCallback, mUiHandler);
    }
    ...
    private CameraCaptureSession.CaptureCallback mCaptureCallback
        ...
        public void onCaptureCompleted(CameraCaptureSession session, CaptureRequest request,
            ...
            if (tag == mManualExposureTag) {
                mManualExposureText.setText(exposureText);

                mManualExposureText.setEnabled(true);
                mAutoExposureText.setEnabled(false);
            } else {
                mAutoExposureText.setText(exposureText);

                mManualExposureText.setEnabled(false);
    ...
    public void onCameraReady() {
        ...
        try {
            ...
            mBuilder.addTarget(mProcessingSurface);
